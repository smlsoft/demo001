...
const FEATURES = [
  ...
  { icon: "🤖", title: "น้องบัญชี AI", desc: "เลขาส่วนตัว จำบริบทได้ ให้คำแนะนำการเงิน คุยได้ทุกเรื่อง" },
  { icon: "📷", title: "อ่านรูป slip/ใบเสร็จ", desc: "ส่งรูป → AI วิเคราะห์ → ถามยืนยัน → บันทึกให้อัตโนมัติ" },
  { icon: "📊", title: "รายงานกราฟ", desc: "กราฟแท่งรายวัน กราฟวงกลมตามหมวด เลือกช่วงวันที่ได้" },
  { icon: "💬", title: "Telegram Bot", desc: "ใช้ผ่าน Telegram ได้เลย ส่งข้อความ ส่งรูป เหมือนเว็บ" },
  { icon: "📁", title: "เก็บเอกสาร/รูปภาพ", desc: "เก็บถาวรบน Cloud แยกตามคน รูปจาก Telegram เก็บให้ด้วย" },
  { icon: "🌙", title: "ธีมมืด/สว่าง", desc: "เปลี่ยนได้ตามชอบ สบายตาทั้งกลางวันกลางคืน" },
  { icon: "📱", title: "ออกแบบสำหรับมือถือ", desc: "ตัวหนังสือใหญ่ ปุ่มใหญ่ ภาษาไทย 100% ชาวบ้านใช้ง่าย" },
];
...
export function LandingPage() {
  ...
  └── 🌐 เว็บ (มือถือ/คอม)
   ...
   └── OpenRouter/Gemini (สำรอง)
         │
         ▼
   MongoDB Atlas (ข้อมูล) + R2 (ไฟล์)`}</pre>
          </div>
        </div>
      </section>
