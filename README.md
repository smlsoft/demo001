...
- 🤖 **น้องบัญชี AI** — เลขาส่วนตัวจำบริบทได้ เตือนงบ/หนี้/เป้าออม ให้คำแนะนำการเงิน
- 📷 **อ่านรูป slip/ใบเสร็จ** — ส่งรูป → AI วิเคราะห์ → ถามยืนยัน → บันทึกอัตโนมัติ
- 🧾 **Slip เงินเข้า/เงินออก** — ถ่ายรูป slip โอนเงิน AI อ่านอัตโนมัติ แยกเงินเข้า-ออก
- 📥 **เอกสารเงินเข้า/ออก** — เก็บใบเสร็จ บิล สัญญา แยกหมวดเงินเข้า-เงินออก
...
### ช่องทางใช้งาน
- 🔐 **Google Sign-In** — เข้าสู่ระบบด้วย Google ข้อมูลแยกตาม Email ส่วนตัว
...
│   │   ├── export-pdf/      # ส่งออก PDF
│   │   ├── files/           # จัดการไฟล์ (R2) + Slip + เอกสาร
│   │   ├── forecast/        # AI พยากรณ์
│   │   ├── recurring/       # รายการซ้ำ
│   │   ├── reminders/       # แจ้งเตือน
...
│   │   ├── seed/            # Reset + Seed ข้อมูลตัวอย่าง
│   ├── dashboard/           # หน้าจอหลัก (16 หน้า)
